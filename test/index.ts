"use strict";
/* global describe, it */
import reportTo from "..";
import supertest from "supertest";
import assert from "assert";
import connect from "connect";

// if you don't want the linter to highlight the type errors,
// be sure to add the @ts-ignore comments above the errors
...
describe("reportTo", function () {
	it("fails without at least 1 group", function () {
		// @ts-ignore showing an example of how to suppress the linter error highlight
	...
	it("expect individual report group", function () {
		return supertest(
			...
			.expect(
				"Report-To",
				'{"group":"endpoint-1","max_age":10886400,"endpoints":[{"url":"https://example.com/reports","priority":1},{"url":"https://backup.com/reports","priority":2}]}'
			)
			.expect("Hello world!");
	});
